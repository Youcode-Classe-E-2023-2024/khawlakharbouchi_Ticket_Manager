...
<section class="bg-indigo-500 dark:bg-gray-800 font-poppins">
 ...
 <form action="singIn.php" method="POST" class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center px-5 py-5">
        <div class="border border-indigo-600 bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    ...
                    <div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button
                                type="submit" value="Login" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">SIGN
                                    IN</button>
                            </div>
                        </div>
                    </div>
